...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BulletinBoard",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13BulletinBoard22BulletinBackgroundView")
@interface BulletinBackgroundView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// on completion.
SWIFT_CLASS("_TtC13BulletinBoard34BulletinDismissAnimationController")
@interface BulletinDismissAnimationController : NSObject <UIViewControllerAnimatedTransitioning>
...
SWIFT_CLASS("_TtC13BulletinBoard39BulletinPresentationAnimationController")
@interface BulletinPresentationAnimationController : NSObject <UIViewControllerAnimatedTransitioning>
- (NSTimeInterval)transitionDuration:(id <UIViewControllerContextTransitioning> _Nullable)transitionContext SWIFT_WARN_UNUSED_RESULT;
- (void)animateTransition:(id <UIViewControllerContextTransitioning> _Nonnull)transitionContext;
...
SWIFT_CLASS("_TtC13BulletinBoard34BulletinSwipeInteractionController")
@interface BulletinSwipeInteractionController : UIPercentDrivenInteractiveTransition <UIGestureRecognizerDelegate>
...
@interface BulletinViewController (SWIFT_EXTENSION(BulletinBoard)) <UIViewControllerTransitioningDelegate>
